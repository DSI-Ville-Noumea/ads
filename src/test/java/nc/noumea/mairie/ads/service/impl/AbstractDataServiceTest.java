...
public abstract class AbstractDataServiceTest {
	 ...
	 * @return Entite
	 */
	protected Entite constructEntite(Integer idEntite, String codeService, boolean withEnfant, Entite entite) {
	...
	protected void checkEntiteDto(EntiteDto result, Entite n, boolean withEnfant, Entite entite) {
	...
	protected void checkEntite(Entite result, EntiteDto n, boolean withEnfant) {
		...
		if (withEnfant) {
			...
			// assertEquals(new DateTime(2015,6,5,0,0,0).toDate(),
			// enfant.getDateCreation());
