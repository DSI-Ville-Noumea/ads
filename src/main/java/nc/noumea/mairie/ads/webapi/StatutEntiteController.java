...
public class StatutEntiteController {
	...
	/**
	 * Methode POST : change le statut d'une entite (option : avec les entites fille) <br />
	 ...
	 * <li>majEntitesEnfant boolean : TRUE pour changer le statut des entites fille egalement, sinon FALSE</li>
	...
	@ResponseBody
	public ReturnMessageDto changeStatutEntite(@RequestBody ChangeStatutDto dto) {
